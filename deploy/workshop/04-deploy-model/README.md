# Module 4: Deploy a Model from the Catalog
...
!!! note "Skippable -- only needed for on-cluster model serving"
    If you skipped Modules 1 and 3, skip this module and continue to
    [Module 5 -- Model Endpoint](../05-model-endpoint/README.md).

**Prerequisites:**

- Module 1 complete (GPU node with HardwareProfile)
- Module 3 complete (MaaS infrastructure running)

> **Working directory:** `cd deploy/workshop/04-deploy-model`
...
**Next**: [Module 5 -- Model Endpoint](../05-model-endpoint/README.md)
