...
!!! note "Skippable -- only needed for on-cluster model serving"
    If you skipped Module 1 (no GPU), skip this module and
    [Module 4](../04-deploy-model/README.md) as well. Continue to
    [Module 5 -- Model Endpoint](../05-model-endpoint/README.md).

**Prerequisites:**

- Module 0 complete (RHOAI operators installed)
- Module 2 complete (RHCL operator and `data-science-gateway-class` GatewayClass)
- Module 1 complete (GPU node available)

> **Working directory:** `cd deploy/workshop/03-models-as-a-service`
...
**Next**: [Module 4 -- Deploy a Model](../04-deploy-model/README.md)
