# Module 17: Agent Testing Through the Gateway (Optional Model Track)

Observe how identity-based tool filtering changes what the agent can do.
The agent deployed in Module 16 is already connected to the MCP Gateway
...
**Prerequisites:**
- Module 16 complete (agent, gateway proxy, and chat UI deployed with admin credentials)
- Modules 6--8 complete (Keycloak + AuthPolicies deployed)

> **Working directory:**
>
> ```bash
> cd deploy/workshop/17-agent-test
> ```
...
**Next**: [Module 18 -- Gen AI Playground](../18-playground/README.md)
