# Module 16: Deploy the Agent Stack (Optional Model Track)
...
**Prerequisites:**
- Core path (Modules 1--8) complete (MCP Gateway, MCP server, identity, AuthPolicies) and Module 15 (Model Endpoint)
- `MODEL_ENDPOINT`, `MODEL_NAME`, and `OPENAI_API_KEY` from Module 15
- `helm` CLI installed
...
MCP_GATEWAY_URL="https://mcp-gateway.${CLUSTER_DOMAIN}/mcp"   # the one gateway URL from Module 2
...
**Next**: [Module 17 -- Agent Testing](../17-agent-test/README.md)
