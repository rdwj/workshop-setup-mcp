# Module 12: Add a GPU Compute Node (Optional Model Track)
...
!!! note "Skippable -- no GPU required for the core workshop"
    ...
    [Module 13 -- Models as a Service](../13-models-as-a-service/README.md) or back to the core path.
...
> **Working directory:** `cd deploy/workshop/12-gpu-node`
...
**Next**: [Module 13 -- Models as a Service](../13-models-as-a-service/README.md)

!!! note "Continue while the GPU node provisions"
    If the GPU node is still provisioning or drivers are still
    installing, continue with the core path. You will verify the GPU node
    in Module 13 before deploying a model.
